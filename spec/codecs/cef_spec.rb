...
describe LogStash::Codecs::CEF do
  ...
  context "#decode" do
    ...
    let (:translate_abbreviated_cef_fields) {'CEF:0|security|threatmanager|1.0|100|trojan successfully stopped|10|src=10.0.0.192 dst=12.121.122.82 proto=TCP shost=source.host.name dhost=destination.host.name spt=11024 dpt=9200 outcome=Success amac=00:80:48:1c:24:91 dvcmac=00:80:48:66:77:88'}
	...
	insist { e.get("deviceMacAddress")} == "00:80:48:66:77:88"
      end
    end
